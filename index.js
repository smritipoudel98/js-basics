...
// const { toProperCase } = require("./practice.js/node");
// const res = toProperCase("password");
// console.log({ res });

// const { number } = require("./practice.js/node");
// const resu = number("10000");
// console.log({ resu });

//slug,description generator,email validation..(assignments)
const { slugify } = require("./practice.js/node");
const slug = slugify("This is a Sample String!");
console.log(slug);
